...
namespace Merge.HRISClient.Api
{
    ...
    /// </summary>
    public interface IEmployeePayrollRunsApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IEmployeePayrollRunsApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IEmployeePayrollRunsApi : IEmployeePayrollRunsApiSync, IEmployeePayrollRunsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class EmployeePayrollRunsApi : IEmployeePayrollRunsApi
    {
        private Merge.HRISClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeePayrollRunsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public EmployeePayrollRunsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public EmployeePayrollRunsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public EmployeePayrollRunsApi(Merge.HRISClient.Client.Configuration configuration)
        {
        ...
        public EmployeePayrollRunsApi(Merge.HRISClient.Client.ISynchronousClient client, Merge.HRISClient.Client.IAsynchronousClient asyncClient, Merge.HRISClient.Client.IReadableConfiguration configuration)
        {
        ...
        public Merge.HRISClient.Client.ApiResponse<PaginatedEmployeePayrollRunList> EmployeePayrollRunsListWithHttpInfo(string xAccountToken, DateTime? createdAfter = default(DateTime?), DateTime? createdBefore = default(DateTime?), string cursor = default(string), string employeeId = default(string), string expand = default(string), bool? includeRemoteData = default(bool?), DateTime? modifiedAfter = default(DateTime?), DateTime? modifiedBefore = default(DateTime?), int? pageSize = default(int?), string payrollRunId = default(string), string remoteId = default(string))
        {
            ...
            if (xAccountToken == null)
                throw new Merge.HRISClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling EmployeePayrollRunsApi->EmployeePayrollRunsList");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Merge.HRISClient.Client.ClientUtils.ParameterToMultiMap("", "payroll_run_id", payrollRunId));
            }
            if (remoteId != null)
            {
            ...
            var localVarResponse = this.Client.Get<PaginatedEmployeePayrollRunList>("/employee-payroll-runs", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("EmployeePayrollRunsList", localVarResponse);
        ...
        public async System.Threading.Tasks.Task<Merge.HRISClient.Client.ApiResponse<PaginatedEmployeePayrollRunList>> EmployeePayrollRunsListWithHttpInfoAsync(string xAccountToken, DateTime? createdAfter = default(DateTime?), DateTime? createdBefore = default(DateTime?), string cursor = default(string), string employeeId = default(string), string expand = default(string), bool? includeRemoteData = default(bool?), DateTime? modifiedAfter = default(DateTime?), DateTime? modifiedBefore = default(DateTime?), int? pageSize = default(int?), string payrollRunId = default(string), string remoteId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PaginatedEmployeePayrollRunList>("/employee-payroll-runs", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Merge.HRISClient.Client.ApiResponse<EmployeePayrollRun> EmployeePayrollRunsRetrieveWithHttpInfo(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.HRISClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling EmployeePayrollRunsApi->EmployeePayrollRunsRetrieve");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<EmployeePayrollRun>("/employee-payroll-runs/{id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("EmployeePayrollRunsRetrieve", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        public async System.Threading.Tasks.Task<Merge.HRISClient.Client.ApiResponse<EmployeePayrollRun>> EmployeePayrollRunsRetrieveWithHttpInfoAsync(string xAccountToken, Guid id, string expand = default(string), bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<EmployeePayrollRun>("/employee-payroll-runs/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
