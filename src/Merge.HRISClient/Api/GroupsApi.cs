...
namespace Merge.HRISClient.Api
{
    ...
    public interface IGroupsApiSync : IApiAccessor
    {
        ...
        Group GroupsRetrieve(string xAccountToken, Guid id, bool? includeRemoteData = default(bool?));
        ...
        ApiResponse<Group> GroupsRetrieveWithHttpInfo(string xAccountToken, Guid id, bool? includeRemoteData = default(bool?));
    ...
    public interface IGroupsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Group> GroupsRetrieveAsync(string xAccountToken, Guid id, bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Group>> GroupsRetrieveWithHttpInfoAsync(string xAccountToken, Guid id, bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class GroupsApi : IGroupsApi
    {
        ...
        {
            Merge.HRISClient.Client.ApiResponse<PaginatedGroupList> localVarResponse = GroupsListWithHttpInfo(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        {
            Merge.HRISClient.Client.ApiResponse<PaginatedGroupList> localVarResponse = await GroupsListWithHttpInfoAsync(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeRemoteData">Whether to include the original data Merge fetched from the third-party to produce these models. (optional)</param>
        /// <returns>Group</returns>
        public Group GroupsRetrieve(string xAccountToken, Guid id, bool? includeRemoteData = default(bool?))
        {
            Merge.HRISClient.Client.ApiResponse<Group> localVarResponse = GroupsRetrieveWithHttpInfo(xAccountToken, id, includeRemoteData);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeRemoteData">Whether to include the original data Merge fetched from the third-party to produce these models. (optional)</param>
        /// <returns>ApiResponse of Group</returns>
        public Merge.HRISClient.Client.ApiResponse<Group> GroupsRetrieveWithHttpInfo(string xAccountToken, Guid id, bool? includeRemoteData = default(bool?))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Group</returns>
        public async System.Threading.Tasks.Task<Group> GroupsRetrieveAsync(string xAccountToken, Guid id, bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Merge.HRISClient.Client.ApiResponse<Group> localVarResponse = await GroupsRetrieveWithHttpInfoAsync(xAccountToken, id, includeRemoteData, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Group)</returns>
        public async System.Threading.Tasks.Task<Merge.HRISClient.Client.ApiResponse<Group>> GroupsRetrieveWithHttpInfoAsync(string xAccountToken, Guid id, bool? includeRemoteData = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xAccountToken' is set
            if (xAccountToken == null)
                throw new Merge.HRISClient.Client.ApiException(400, "Missing required parameter 'xAccountToken' when calling GroupsApi->GroupsRetrieve");
