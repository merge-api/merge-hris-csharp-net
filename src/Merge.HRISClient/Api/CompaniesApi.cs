...
namespace Merge.HRISClient.Api
{
    ...
    public partial class CompaniesApi : ICompaniesApi
    {
        ...
        {
            Merge.HRISClient.Client.ApiResponse<PaginatedCompanyList> localVarResponse = CompaniesListWithHttpInfo(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        {
            Merge.HRISClient.Client.ApiResponse<PaginatedCompanyList> localVarResponse = await CompaniesListWithHttpInfoAsync(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
