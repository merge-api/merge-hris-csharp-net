...
namespace Merge.HRISClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmploymentRequest")]
    public partial class EmploymentRequest : IEquatable<EmploymentRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmploymentRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EmploymentRequest);
        }

        /// <summary>
        /// Returns true if EmploymentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EmploymentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmploymentRequest input)
        {
            if (input == null)
                return false;
