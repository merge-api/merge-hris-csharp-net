...
namespace Merge.HRISClient.Test.Api
{
    ...
    public class CompaniesApiTests : IDisposable
    {
        ...
        public void CompaniesListTest()
        {
            ...
            //var response = instance.CompaniesList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
