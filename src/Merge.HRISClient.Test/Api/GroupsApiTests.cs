...
namespace Merge.HRISClient.Test.Api
{
    ...
    public class GroupsApiTests : IDisposable
    {
        ...
        public void GroupsListTest()
        {
            ...
            //var response = instance.GroupsList(xAccountToken, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId);
        ...
        public void GroupsRetrieveTest()
        {
            ...
            //Guid id = null;
            //bool? includeRemoteData = null;
            //var response = instance.GroupsRetrieve(xAccountToken, id, includeRemoteData);
