...
# **EmploymentsCreate**
> Employment EmploymentsCreate (string xAccountToken, bool? runAsync = null, EmploymentRequest employmentRequest = null)
...
namespace Example
{
    public class EmploymentsCreateExample
    {
        public static void Main()
        {
            ...
            var employmentRequest = new EmploymentRequest(); // EmploymentRequest |  (optional) 
            ...
            {
                Debug.Print("Exception when calling EmploymentsApi.EmploymentsCreate: " + e.Message );
...
# **EmploymentsList**
> PaginatedEmploymentList EmploymentsList (string xAccountToken, DateTime? createdAfter = null, DateTime? createdBefore = null, string cursor = null, string employeeId = null, bool? includeRemoteData = null, DateTime? modifiedAfter = null, DateTime? modifiedBefore = null, int? pageSize = null, string remoteId = null)
