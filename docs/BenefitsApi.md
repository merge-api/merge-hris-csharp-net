# Merge.HRISClient.Api.BenefitsApi
...
namespace Example
{
    public class BenefitsListExample
    {
        public static void Main()
        {
            ...
            var employeeId = employeeId_example;  // string | If provided, will return the benefits associated with the employee. (optional) 
            ...
            {
                Debug.Print("Exception when calling BenefitsApi.BenefitsList: " + e.Message );
 ...
 **employeeId** | **string**| If provided, will return the benefits associated with the employee. | [optional] 
...
namespace Example
{
    public class BenefitsRetrieveExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling BenefitsApi.BenefitsRetrieve: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
